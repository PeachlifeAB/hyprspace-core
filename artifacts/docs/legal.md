...
- `artifacts/docs/` — shipped config and legal disclosure docs
- `artifacts/configs/` — default sketchybar and AeroSpace config examples
- `artifacts/gfx/` — bundled wallpaper and release-managed icon source assets
- `scripts/internal/` — optional setup helpers (dependency install, macOS defaults, sketchybar config)
